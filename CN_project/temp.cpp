...
public:
    Hub(int id, string name, int device_id, string device_name, string ip_address, string mac_address, Network* net)
        : EndDevice(device_id, device_name, network, mac_address, subnet_mask) {
        hub_id = id;
        hub_name = name;
        network = net;
    }
...
private:
    ...
    public:
    Router(int id, string name, int device_id, string device_name, string ip_address, string mac_address)
        : EndDevice(device_id, device_name, network, mac_address, subnet_mask) {
        
        router_id = id;
        router_name = name;
        routingProtocol = nullptr;  //initializing pointer
    }
...
int main() {
    ...
    Router router1(1, "Router 1", 1, "Device 1", "192.168.0.1", "00:00:00:00:00:01");
    Router router2(2, "Router 2", 11, "Router 2 Device", "192.168.1.10", "00:00:00:00:00:02");
    ...
    EndDevice device1(1, "Device 1", &network, "00:00:00:00:00:01", "255.255.255.0");
    EndDevice device2(2, "Device 2", &network, "00:00:00:00:00:02", "255.255.255.0");
    EndDevice device3(3, "Device 3", &network, "00:00:00:00:00:03", "255.255.255.0");
    EndDevice device4(4, "Device 4", &network, "00:00:00:00:00:04", "255.255.255.0");
    EndDevice device5(5, "Device 5", &network, "00:00:00:00:00:05", "255.255.255.0");
    ...
    EndDevice device6(6, "Device 6", &network, "00:00:00:00:00:08", "255.255.255.0");
    EndDevice device7(7, "Device 7", &network, "00:00:00:00:00:09", "255.255.255.0");
    EndDevice device8(8, "Device 8", &network, "00:00:00:00:00:10", "255.255.255.0");
    EndDevice device9(9, "Device 9", &network, "00:00:00:00:00:11", "255.255.255.0");
    EndDevice device10(10, "Device 10", &network, "00:00:00:00:00:12", "255.255.255.0");
    ...
    EndDevice device11(11, "Device 11", &network, "00:00:00:00:00:13", "255.255.255.0");
    EndDevice device12(12, "Device 12", &network, "00:00:00:00:00:14", "255.255.255.0");
    EndDevice device13(13, "Device 13", &network, "00:00:00:00:00:15", "255.255.255.0");
    EndDevice device14(14, "Device 14", &network, "00:00:00:00:00:16", "255.255.255.0");
    EndDevice device15(15, "Device 15", &network, "00:00:00:00:00:17", "255.255.255.0");
